...
class _$ProductSearchStateImpl extends _ProductSearchState {
  ...
  @override
  String toString() {
    return 'ProductSearchState(products: $products, query: $query, skip: $skip, limit: $limit, total: $total, isLoading: $isLoading, isLoadMore: $isLoadMore, sortBy: $sortBy, order: $order, selectedCategory: $selectedCategory)';
  }
